<template>
  <div>
    <section class="relative py-10 bg-gray-900 sm:py-16 lg:py-24 -z-10">
      ...
      <div class="relative mt-12 max-w-lg px-4 py-8 mx-auto sm:px-0">
        <div class="overflow-hidden bg-white rounded-md shadow-md">
          <div class="px-4 py-6 sm:px-8 sm:py-7">
            <div class="text-center">
              <h2 class="text-3xl font-bold text-gray-900">Welcome back</h2>
              <p class="mt-2 text-base text-gray-600">Don’t have one? <a href="#" title="" class="text-blue-600 transition-all duration-200 hover:underline hover:text-blue-700">Create a free account</a></p>
            </div>
